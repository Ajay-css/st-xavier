...
import lasac from "../assets/LASAC.jpg"
import pta from "../assets/pta.jpg"
import scout from "../assets/scout.jpg"
import staar from "../assets/staar.jpg"
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: ncc, text: 'National Cadet Corps' },
      { image: nss, text: 'National Service Scheme' },
      { image: jrc, text: 'Junior Red Cross' },
      { image: lasac, text: 'LASAC' },
      { image: pta, text: 'Parents Teachers Assocation' },
      { image: scout, text: 'Scout' },
      { image: staar, text: 'Staar' },
      { image: rsp, text: 'Road Safety Patrol' },
    ];
